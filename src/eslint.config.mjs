 ...
 *   npx eslint --config path/to/src/eslint.config.mjs src/
 *
 ...
 *
 * Plugin: the local fuselage-craft-gate plugin (eslint-plugin/index.mjs).
 */

import { createRequire } from 'module';
import { fileURLToPath } from 'url';
import { dirname, resolve } from 'path';
import fuselageCraftGate from './eslint-plugin/index.mjs';
 ...
 *  2. This toolkit's own node_modules (when toolkit has its own install)
